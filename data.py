...
# ---------------------------------------------------------------------------
LIFESTYLE_PRESETS = {
    # ミニマム生活：自炊中心・バイク移動・外食/交際/趣味/物品購入をかなり抑える、
...
LIFESTYLE_DESCRIPTIONS = {
    "ミニマム生活": "支出をかなり抑えた生活です。住まいを安くできる場合や、自炊中心で外食・交際・趣味を控えめにする場合の目安です。",
    "節約生活": "基礎生活を保ちながら、日々の支出を意識して抑える生活です。外食・交際・趣味は少なめですが、無理のない範囲で生活の余白も残します。",
    "標準生活": "食費・外食・交際・趣味をある程度残す、無理の少ない生活です。タイで長期滞在するうえで、生活の安定と楽しみのバランスを取りやすい目安です。",
    "余裕生活": "外食・交際・趣味・レジャーにも余白を持たせる生活です。住まい・医療・移動手段にも一定のゆとりを見込み、快適さを重視する場合の目安です。",
}
